...
class MatchEQ(abc.ABC):
    def __init__(self, RT_Dataset: Dataloader, num_of_iter: int, num_of_bands: int, num_of_delays: int, sample_rate: int, device: str):
        ...
        self.min_delay_in_samples = int(self._min_delay_in_seconds * self.sample_rate)
        self.max_delay_in_samples = int(self._max_delay_in_seconds * self.sample_rate)
