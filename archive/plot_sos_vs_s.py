...
ir, sos_response = Filters.evaluate_sos_response(freqency_axis, cutoff_freqs, gains, Q)
...
plt.savefig(os.path.join(os.path.dirname(os.path.realpath(__file__)), "ir.png"))